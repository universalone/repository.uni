...
ADDONTITLE     = '[COLOR aqua]NY Builds Wizard[/COLOR]'
BUILDERNAME    = 'Universal1'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repository.firetvguru', 'roms', 'My_Builds', 'backupdir']
BUILDFILE      = 'https://archive.org/download/builds_201903/builds.txt'
UPDATECHECK    = 0
APKFILE        = 'http://'
YOUTUBETITLE   = '' 
YOUTUBEFILE    = 'http://'
...
WIZTITLE = 'NY Builds Wizard'
WIZTITLE_COLOR = 'magenta'
VERTITLE_COLOR = 'aqua'
VER_NUMBER_COLOR = 'magenta'
############################################################
...
ICONBUILDS     = 'https://ia801209.us.archive.org/18/items/image_20161009/image.jpg'
ICONMAINT      = ''
ICONAPK        = ''
ICONADDONS     = ''
ICONYOUTUBE    = ''
...
WIZARDFILE     = 'https://archive.org/download/builds_201903/builds.txt'
#########################################################
...
# Font size of header
FONTHEADER     = 'Font13'
HEADERMESSAGE  = 'NY Builds Wizard'
